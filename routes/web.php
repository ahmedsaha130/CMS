...
Route::group(['middleware' => 'verified'], function() {
    ...
    Route::get('/edit-info',                           ['as' => 'users.edit.info',        'uses' => 'Frontend\UserController@edit_info']);
    Route::post('/edit-info',                          ['as' => 'users.update.info',        'uses' => 'Frontend\UserController@update_info']);
    Route::post('/edit-password',                      ['as' => 'users.update.password',        'uses' => 'Frontend\UserController@update_password']);

    Route::get('/create-post',                          ['as' => 'users.post.create',        'uses' => 'Frontend\UserController@create_post']);
    Route::post('/create-post',                          ['as' => 'users.post.store',        'uses' => 'Frontend\UserController@store_post']);
    Route::get('/edit-post/{post_id}',                   ['as' => 'users.post.edit',        'uses' => 'Frontend\UserController@edit_post']);
    Route::put('/edit-post/{post_id}',                  ['as' => 'users.post.update',        'uses' => 'Frontend\UserController@update_post']);
    Route::post('/delete-post-media/{media_id}',        ['as' => 'users.post.media.destroy',        'uses' => 'Frontend\UserController@destory_post_media']);
    Route::delete('/delete-post/{post_id}',              ['as' => 'users.post.destroy',        'uses' => 'Frontend\UserController@destory_post']);
    Route::get('/comments',                              ['as' => 'users.comments',        'uses' => 'Frontend\UserController@show_comments']);
    Route::get('/edit-comments/{comment_id}',            ['as' => 'users.comment.edit',        'uses' => 'Frontend\UserController@edit_comment']);
    Route::put('/edit-comments/{comment_id}',            ['as' => 'users.comment.update',        'uses' => 'Frontend\UserController@update_comment']);
    Route::delete('/comment-comments/{comment_id}',      ['as' => 'users.comment.destroy',        'uses' => 'Frontend\UserController@destroy_comment']);
