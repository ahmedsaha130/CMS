                ...
                <div class="col-lg-9 col-12">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @forelse($comments as $comment)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" onclick="if (confirm('Are you sure to delete this post?') ) { document.getElementById('comment-delete-{{ $comment->id }}').submit(); } else { return false; }" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4">No Commnets found</td>
                                </tr>
                            @endforelse
                            </tbody>
                            <tfoot>
