...
class UserController extends Controller
{
    ...
    public function index (){
        ...
        $posts = auth()->user()->posts()->with(['category','media','user'])->withCount('comments')
    ...
    public function update_info( Request  $request){
        ...
        $validation = Validator::make($request->all(),[
            ...
            'user_image'=>'nullable|image|max:20000|mimes:jpg,png,jpeg',
        ]);
        if ($validation->fails()){
        ...
        if ($image = $request->file('user_image')){
            ...
            Image::make($image->getRealPath())->resize(800, 300, function ($constraint) {
    ...
    public function update_password(Request  $request){
        ...
        if ($update){
            Auth::logout();
            return  redirect()->route('frontend.show_login_from')->with([
    ...
    public function destory_post($post_id)
    {
    ...
    public function destory_post_media($media_destroy){


                $media = PostMedia::whereId($media_destroy)->first() ;
